        ...
        //auto-select gunung dari halaman destinasi
...
<button class="text-xs bg-green-50 text-green-600 font-bold px-3 py-1.5 rounded hover:bg-green-500 hover:text-white transition mr-2" onclick="editBooking(${b.id})">Edit</button>
